<template>
    <div id="pay">
        ...
        <main class="main">
           <div class="addr">
               <router-link :to="{path:'/address'}"  class="right"><i class="rsiconfont rsicon-qiehuanqiyou"></i></router-link>
               <span class="left"><i class="rsiconfont rsicon-address"></i></span>
               <div class="con">
                   <p><span>{{userInfo.addr.userName}}</span>&nbsp;&nbsp;&nbsp;&nbsp;<span>{{userInfo.addr.userPhone}}</span></p>
                   <p><span>{{userInfo.addr.value}} {{userInfo.addr.detailedAddress}}</span></p>
               </div>
           </div>
           <div class="order">
           ...
           <div class="payList">
               <div 
                class="payItem payWeixin" 
                v-for="(item, index) in payList"
                :key="index"
                :class="item.className"
                :dataType="item.dataType"
                :payTypeId="item.payTypeId"
                @click="changePay(item.payTypeId)">
        ...
        <footer class="footer">
            <span><i class="rsiconfont rsicon-yduidunpaishixin"></i>实付款：</span>
    ...
    mounted(){
        ...
        addressList.forEach((item, index)=>{
            if(item.default === true){
                this.userInfo.addr = addressList[index]
            }
        })
    },
    methods:{
